...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
    ...
    movie->setScaledSize(QSize(389,391));
    connect(toggle_record, &QPushButton::clicked, this, &MainWindow::startRecord);
    toggle_record->setIconSize(QSize(389,391));
    toggle_record->setFixedHeight(389);
    toggle_record->setFixedWidth(391);
    ...
    vertical_layout->setContentsMargins(7, 10, 7, 10);
    vertical_layout->setSpacing(7);
...
void MainWindow::getRecognizedSpeech(QString speechToText)
{
    ...
    emit requestCommand(speechToText);   //Отправка команды на выполнение
}
